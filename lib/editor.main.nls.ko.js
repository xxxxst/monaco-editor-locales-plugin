...
module.exports = {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"줄 바꿈 행의 들여쓰기를 제어합니다. \'none\', \'same\', \'indent\' 또는 \'deepIndent\' 중 하나일 수 있습니다.",
		...
		"편집기에서 CodeLens를 표시하는지 여부를 제어합니다.",
		"편집기에서 코드 접기를 사용할지 여부를 제어합니다.",
		"접기 범위를 계산하는 방식을 제어합니다. \'자동\' 선택이면 사용 가능한 경우 언어 관련 접기 전략을 사용합니다. \'들여쓰기\'이면 들여쓰기 기반 접기 전략이 사용됩니다.",
		...
		"코드 동작 전구를 사용합니다.",
		"저장할 때 가져오기 구성을 실행하시겠습니까?",
		"저장할 때 실행되는 코드 동작 종류입니다.",
		"저장할 때 실행되는 코드 동작에 대한 시간 제한입니다.",
	...
	"vs/editor/contrib/format/formatActions": [
		...
		"문서 서식",
		" \'{0}\'-파일에 대한 문서 포맷터가 설치되어 있지 않습니다.",
		"선택 영역 서식",
		"\'{0}\'-파일에 대한 선택 영역 포맷터가 설치되어 있지 않습니다.",
	],
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"검색을 제한하는 범위의 색입니다. 이 색은 기본 장식을 가리지 않도록 불투명하지 않아야 합니다.",
		"현재 검색과 일치하는 테두리 색입니다.",
		"다른 검색과 일치하는 테두리 색입니다.",
		"검색을 제한하는 범위의 테두리 색입니다. 이 색은 기본 장식을 가리지 않도록 불투명하지 않아야 합니다.",
