...
module.exports = {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Controla el sangrado de las líneas ajustadas. Puede ser uno de \'none\', \' same \', \' indent\' o \' deepIndent \'.",
		...
		"¿organizar importaciones en guardar?",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Color de la gama que limita la búsqueda. El color no debe ser opaco para no ocultar las decoraciones subyacentes.",
		"Color de borde de la coincidencia de búsqueda actual.",
		"Color de borde de otra búsqueda que coincide.",
		"Color de borde de la gama que limita la búsqueda. El color no debe ser opaco para no ocultar las decoraciones subyacentes.",
