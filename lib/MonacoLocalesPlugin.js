...
function MonacoLocalesPlugin(options){
	this.options = {
		/**
...
module.exports = MonacoLocalesPlugin;

MonacoLocalesPlugin.prototype.apply = function(compiler) {
	var local = this;

	compiler.plugin("compilation", function(compilation) {
		compilation.hooks.succeedModule.tap('MonacoLocalesPlugin', (wpModule) => {
			if(!wpModule.resource || !wpModule.resource.indexOf || wpModule.resource.indexOf("esm\\vs\\nls.js")<0){
				return;
			}
...
MonacoLocalesPlugin.prototype.initLang = function(){
...
MonacoLocalesPlugin.prototype.initOneLang = function(rstObj, en, langObj){
	for (var key in en) {
...
MonacoLocalesPlugin.prototype.initSelfOneLang = function(rstObj, obj){
	for (var key in obj) {
...
MonacoLocalesPlugin.prototype.getSelectLangStr = function(){
...
MonacoLocalesPlugin.prototype.getLangIdx = function(en){
...
MonacoLocalesPlugin.prototype.init = function(){
	//{en:index}
	this.mapLangIdx = {};
