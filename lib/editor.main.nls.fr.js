...
module.exports = {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Contrôle le nombre de caractères supplémentaires, au-delà duquel l’éditeur défilera horizontalement",
		...
		"Contrôle la mise en retrait des lignes enveloppées. Il peut s’agir de \'none\', \'same\', \'indent\' ou \'deepIndent\'.",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Couleur de la plage limitant la recherche. La couleur ne doit pas être opaque pour ne pas masquer les décorations sous-jacentes.",
		"Couleur de bordure du résultat de recherche actif.",
		"Couleur de bordure des autres résultats de recherche.",
		"Couleur de la bordure limitant la recherche. La couleur ne doit pas être opaque pour ne pas masquer les décorations sous-jacentes. ",
