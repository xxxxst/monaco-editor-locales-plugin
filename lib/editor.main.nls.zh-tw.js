...
module.exports = {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"控制換行的縮排。可以是 \'none\'、\'same\' 或 \'deepIndent\'。",
		...
		"控制編輯器是否顯示 CodeLens",
		"控制編輯器是否已啟用程式碼摺疊功能",
		"控制折疊範圍的計算方式。\'auto\' 會在可行的情況下挑選使用語言特定摺疊策略。\'indentation\' 則會強制使用縮排式摺疊策略。",
		"自動隱藏摺疊控制向",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"限制搜索的範圍色彩。不能使用非透明的色彩來隱藏基礎樣式。",
		"符合目前搜尋的框線色彩。",
		"符合其他搜尋的框線色彩。",
		"限制搜尋範圍的邊框色彩。不能使用非透明的色彩來隱藏基礎樣式。",
